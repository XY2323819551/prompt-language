...
async def test_from_file():
    ...
    tools = {
        ...
        "paper_with_code_search": paper_with_code_search,
    ...
    # 测试
    root_path = "/Users/zhangxiaoyu/Desktop/WorkSpace/prompt-language/examples/paper"
    file_path = os.path.join(root_path, f"paper.pl")
    try:
